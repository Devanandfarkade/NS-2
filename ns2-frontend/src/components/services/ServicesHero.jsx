    ...
    >
      <div className="container mx-auto px-6 md:px-12 py-12 md:py-20 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-8">
          {/* Left Content */}
          <div className="flex-1 text-center md:text-left md:ml-[120px]">
            ...
            <div className="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
              {bannerData.primary_button_text && (
                <button className="px-6 py-3 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold shadow-lg hover:from-blue-700 hover:to-indigo-700 transition-all duration-300">
                  {bannerData.primary_button_text}
                </button>
              )}
          ...
          <div className="flex-1 flex justify-center relative w-full">
            <div className="relative w-full max-w-sm h-[260px] md:h-[380px] rounded-2xl overflow-hidden shadow-2xl">
              <Image
                src={imageUrl}
                alt="Banner"
                fill

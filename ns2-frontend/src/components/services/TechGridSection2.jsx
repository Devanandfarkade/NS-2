...
export default function TechGridSection2({ data }) {
  ...
  return (
    <section className="relative py-20 px-6 md:px-12 overflow-hidden">
      ...
      {/* Faded Decorative Blobs */}
      <div className="absolute -top-20 -left-20 w-72 h-72 bg-blue-100 opacity-20 rounded-full blur-3xl z-0" />
      <div className="absolute bottom-0 -right-20 w-96 h-96 bg-purple-100 opacity-20 rounded-full blur-3xl z-0" />
          ...
          {items
            ...
            .map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="bg-white rounded-xl p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-transparent hover:border-blue-200"
                >
                  {/* Icon */}
